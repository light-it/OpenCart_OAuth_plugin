<div class="box">
	...
	<div id="loginbycall" class="box-content">
		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="login_module">
			...
			<a href="<? echo $action_loginbycall; ?>" style="display: block; width: 200px; text-decoration: none;" class="loginbycall">
				<img src="http://loginbycall.com/assets/logo.jpg" width="24px" height="24px" style="float: left;" alt="Войти через loginbycall"/>
				<span style="font-size: 14px;
					  ...
					  position: relative;
					  top: 4px;
					  left: 5px; "><?php echo $sign_in_sign_up; ?>
				</span>
			</a>
